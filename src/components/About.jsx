...
const teamMembers = [
  {
    ...
    image: "https://static.wixstatic.com/media/c837a6_abb6c69f34ab4975983c4fef1e6576ea~mv2.jpg",
  },
  {
    name: "John Doe",
  ...
  return (
    <>
      ...
      <section className="about w-full min-h-[100vh] spacer relative">
        ...
        {/* Top Right Text */}
        <div className="main-text-top-left mt-40 absolute left-9 text-left">
          <div className="text-6xl">About Us</div>
          <div className="text-3xl">
            This is a space to share more about the business:<br />
            who's behind it, what it does, and what this site has<br />
            to offer. It’s an opportunity to tell the story behind <br />
            the business or describe a special service or<br />
            product it offers.
          </div>
        </div>

        {/* Bottom Right Text */}
        <div className="main-text-bottom-right absolute bottom-40 right-9 text-right">
          <div className="text-6xl">OUR MISSION</div>
          <div className="text-2xl">
            You can use this section to share the company's history or highlight a<br />
            particular feature that sets it apart from competitors. Let the writing <br />
            speak for itself. Keep a consistent tone and voice throughout the<br />
            website to stay true to the brand image and give visitors a taste of<br />
      ...
      <section className="our-team min-h-auto spacer relative bg-gray-100 py-40">
        ...
        <div className="text-4xl text-center mt-3.5 mb-9"> The Minds Behind TRIGUN</div>
